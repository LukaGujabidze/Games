...
def run():
    # this lines cretes tkinter window
    root = Tk()
    ...
    # this cretetes Varieble named Result and type is str
    Result = StringVar()


    # this lines creates functions for buttons
    def play():
    ...
    # this is label on top of the window to show Rock, Paper, Scissors
    Label(root, text = 'Rock, Paper ,Scissors' , font='arial 20 bold', bg = 'seashell2').pack()


    # in this lines of code it cretets enty screen to enter what you think and to chhose Rock, Paper and etc.
    user_take = StringVar()
    ...
    #this code lines is to pick computer scissors, paper or rock
    comp_pick = random.randint(1,3)
    ...
    # in this code on tkinter window ol label shows result
    Entry(root, font = 'arial 10 bold', textvariable = Result, bg ='antiquewhite2',width = 50,).place(x=25, y = 250)

    # this are buttons to play, reset or exit
